...
BECH32_ADDR=$(cat "$KEYS_DIR/payment.addr")
echo "Funding Address: $BECH32_ADDR"

############################################################
# INSERT INITIAL FUNDS (BECH32 ALLOWED ON SANCHONET)
############################################################

jq ".initialFunds += {\"$BECH32_ADDR\": {\"lovelace\": 1000000000000}}" \
